...
function getDataFromDB(): array|bool {
	...
	$data = mysqli_fetch_all($result, MYSQLI_ASSOC);	//var_dump($data);
	...
	if(sizeof($questions)!=sizeof($reponses)) {
		return false;
	}

	return ['questions'=>$questions, 'reponses'=>$reponses];
}
